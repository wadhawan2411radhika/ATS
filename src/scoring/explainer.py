...
from src.scoring.schemas import ScoringBreakdown
...
def explain(breakdown: ScoringBreakdown, jd_title: str) -> RecruiterExplanation:
    ...
    """
    user_prompt = f"""
Generate a recruiter summary for the following candidate evaluation.
...
TIER SCORES:
- Skills (55%)      : {breakdown.tier1_score:.2f}
- Experience (25%)  : {breakdown.tier2_score:.2f}
- Quality (20%)     : {breakdown.tier3_score:.2f}
